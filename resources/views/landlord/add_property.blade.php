...
<style>
  ...
  <div class="container-fluid">
    ...
    <form action="{{ route('landlord.RegProperty') }}" method="POST" enctype="multipart/form-data">
        <h4>Property Info.</h4>
    ...
    <div class="form-row">
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-2">
            ...
            <input type="number" min="1" name="totBed" class="form-control" id="totBed" required>
          </div>
          <div class="form-group col-md-2">
            <label for="totBath">Total Bathroom(s) </label>
            <input type="number" min="1" name="totBath" class="form-control" id="totBath" required>
          </div>
        ...
        <div class="form-group col-md-3">
            ...
            <input type="number" name="parking" min="0" id="parking" class="form-control" required> 
        </div>
    <!-- </div>
        <div class="form-row"> -->
...
{{-- </div> --}}
                                ...
                                <h3 id="question">  </h3>
                                    <div id="true">
                                        <div id="DivY">
                                            ...
                                            <input type="radio" name="{{ $index }}" id="Y" value="1">
    ...
    <div class="form-row card-body">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="number" name="maxTenant" id="tenant" class="form-control" required>
        </div>
        ...
        <div class="form-group col-md-3">
            ...
            <input type="number" name="misc" id="rent" class="form-control" required>
        </div>
